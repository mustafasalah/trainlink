      ...
      <div className="student-profile">
        <div className="student">
          <div className="profile">
            {user.profileImage ? (
              <Image src={user.profileImage} alt="" width={70} height={70} />
            ) : (
        ...
        <div className="student-profile-info">
          <div className="basic-info">
            ...
            <ul>
              ...
              {user.phoneNumber ? (
                <li>
                  <i className="icon-phone"></i>Phone Number: {user.phoneNumber}
                </li>
              ) : (
                ""
              )}
              ...
              <div className="academic-details">
                ...
                <ul>
                  {user.academic?.department ? (
                    <li>Department/Major: {user.academic.department}</li>
                  ) : (
                    ""
                  )}
                  {user.academic?.college ? (
                    <li>Faculty/College: {user.academic.college}</li>
                  ) : (
                    ""
                  )}
                  {user.academic?.year ? (
                    <li>Year of Study/Graduation Year: {user.academic.year}</li>
                  ) : (
                    ""
                  )}
                  {user.academic?.gpa ? (
                  ...
                  {user.academic?.skills ? (
                    <li>Relevant Skills/Interests: {user.academic.skills}</li>
                  ) : (
                    ""
                  )}
                </ul>
