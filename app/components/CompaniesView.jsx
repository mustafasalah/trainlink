...
export default function CompaniesView({ companies }) {
  ...
  const handleCreate = useCallback(async (formData) => {
    try {
      ...
      // API Call
      await createCompanyAndOwner(companyData, userData, formData.get("photo"));
    } catch (err) {
      console.log(err);
    }
      ...
      <form action={handleCreate}>
        ...
        >
          ...
          <div className="box">
            ...
            <input className="phone" name="phonenumber" type="text" />
          </div>
          <div className="box">
            <label>
          ...
          <div className="box full-width">
            <label>
              <i className="icon-file-text"></i>Company Description
            </label>
            <textarea
              name="about"
          ...
          <div className="box">
            <label htmlFor="agreement-renewal-type">Renewal Type</label>
            <select
